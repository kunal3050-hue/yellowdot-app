...
| ADR | Title | Status |
|---|---|---|
| [0001](0001-freeze-finance-foundation-architecture.md) | Freeze Finance Platform Architecture | Accepted |
| [0002](0002-refund-ledger-entry-sign-convention.md) | Refund Ledger Entry Sign Convention | Accepted |
