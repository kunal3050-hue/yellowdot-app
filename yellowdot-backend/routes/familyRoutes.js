...
router.get("/api/families/:familyId", ...canView, async (req, res) => {
  try {
...
router.put("/api/families/:familyId", ...canMutate, async (req, res) => {
  try {
...
router.delete("/api/families/:familyId", ...canMutate, async (req, res) => {
  try {
...
router.post("/api/families/:familyId/students/:studentId", ...canMutate, async (req, res) => {
  try {
...
router.delete("/api/families/:familyId/students/:studentId", ...canMutate, async (req, res) => {
  try {
...
router.get("/api/families/:familyId/notes", ...canView, async (req, res) => {
  try {
...
router.post("/api/families/:familyId/notes", ...canMutate, async (req, res) => {
  try {
...
router.delete("/api/families/:familyId/notes/:noteId", ...canMutate, async (req, res) => {
  try {
...
router.get("/api/families/:familyId/documents", ...canView, async (req, res) => {
  try {
...
router.post("/api/families/:familyId/documents", ...canMutate, async (req, res) => {
  try {
...
router.delete("/api/families/:familyId/documents/:docId", ...canMutate, async (req, res) => {
  try {
...
router.get("/api/families/:familyId/timeline", ...canView, async (req, res) => {
  try {
...
router.get("/api/families/:familyId/fees-summary", ...canView, async (req, res) => {
  try {
