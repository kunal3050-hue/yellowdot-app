...
export const ROLE_PERMISSIONS = {
  ...
  admin: [              // alias for center_admin
    ...
    ROUTES.HOLIDAYS, ROUTES.NOTICES, ROUTES.ANNOUNCEMENTS, ROUTES.EVENTS, ROUTES.QR_MANAGEMENT, ROUTES.CCTV,
  ...
  teacher: [
    ...
    ROUTES.PROFILE, ROUTES.HOLIDAYS, ROUTES.NOTICES, ROUTES.ANNOUNCEMENTS, ROUTES.EVENTS,
    ROUTES.ACADEMICS_CLASSES, ROUTES.ACADEMICS_BATCHES,
    ROUTES.ACADEMICS_STUDENT_ALLOCATION,
  ],
