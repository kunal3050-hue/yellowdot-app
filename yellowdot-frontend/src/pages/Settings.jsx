...
// ══════════════════════════════════════════════════════════════════
// ICONS  (lucide-react — KUE BOXS Design System v2)
// ══════════════════════════════════════════════════════════════════

import {
  Building, Calendar, CreditCard, Clock, Camera, Users, Shield, Palette,
  Bell, Smartphone, Wallet, Settings as SettingsIcon, Plus, Trash, Check,
  Info, Mail, Save, UserPlus, AlertTriangle, QrCode, GitBranch, Rocket,
} from "lucide-react";

const IC = { w: 16, h: 16, sw: 1.75 };

const LUCIDE_ICONS = {
  Building, Calendar, CreditCard, Clock, Camera, Users, Shield, Palette,
  Bell, Smartphone, Wallet, Settings: SettingsIcon, Plus, Trash, Check,
  Info, Mail, Save, UserPlus, AlertTriangle, QrCode, GitBranch, Rocket,
};
...
const Icons = Object.fromEntries(
  Object.entries(LUCIDE_ICONS).map(([name, LucideIcon]) => [
    name,
    () => <LucideIcon width={IC.w} height={IC.h} strokeWidth={IC.sw} />,
  ])
);
